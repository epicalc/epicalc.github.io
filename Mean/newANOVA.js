...
// Output table;
	...
	newrow("span8:l: &nbsp;  ");
	//newrow("color#66ffff:span3:l:Two-sided confidence interval", "color#66ffff:r:"+fmtSigFig(pt,6)+"%","color#66ffff:span4:l:");
	
	newrow("l:",   "color#ffff99:span2:bold:c: Group",  "color#ffff99:bold:c: N (count)",  "color#ffff99:bold:c:Mean", 	"color#ffff99:bold:c: Std. Dev.", "color#ffff99:bold:c: Std. error", "bold:l:"); 
	newrow("l:",   "color#ffff99:span6:l:&nbsp;",   "l:"); 
	newrow("l:",   "color#66ffff:span2:bold:c: 1:",  "color#66ffff:c:"+space(n[1]),  "color#66ffff:c:"+space(m[1]),  "color#66ffff:c:"+s1,  "color#66ffff:c:"+se1,  "bold:l:"); 
	newrow("l:",   "color#66ffff:span2:bold:c: 2:",  "color#66ffff:c:"+space(n[2]),  "color#66ffff:c:"+space(m[2]),  "color#66ffff:c:"+s2,  "color#66ffff:c:"+se2,  "bold:l:"); 
	newrow("l:",   "color#66ffff:span2:bold:c: 3:",  "color#66ffff:c:"+space(n[3]),  "color#66ffff:c:"+space(m[3]),  "color#66ffff:c:"+s3,  "color#66ffff:c:"+se3,  "bold:l:"); 
	newrow("l:",   "color#66ffff:span2:bold:c: 4:",  "color#66ffff:c:"+space(n[4]),  "color#66ffff:c:"+space(m[4]),  "color#66ffff:c:"+s4,  "color#66ffff:c:"+se4,  "bold:l:"); 
	newrow("l:",   "color#66ffff:span2:bold:c: 5:",  "color#66ffff:c:"+space(n[5]),  "color#66ffff:c:"+space(m[5]),  "color#66ffff:c:"+s5,  "color#66ffff:c:"+se5,  "bold:l:"); 
	newrow("l:",   "color#66ffff:span2:bold:c: 6:",  "color#66ffff:c:"+space(n[6]),  "color#66ffff:c:"+space(m[6]),  "color#66ffff:c:"+s6,  "color#66ffff:c:"+se6,  "bold:l:"); 
	newrow("l:",   "color#66ffff:span2:bold:c: 7:",  "color#66ffff:c:"+space(n[7]),  "color#66ffff:c:"+space(m[7]),  "color#66ffff:c:"+s7,  "color#66ffff:c:"+se7,  "bold:l:"); 
	newrow("l:",   "color#66ffff:span2:bold:c: 8:",  "color#66ffff:c:"+space(n[8]),  "color#66ffff:c:"+space(m[8]),  "color#66ffff:c:"+s8,  "color#66ffff:c:"+se8,  "bold:l:"); 
	newrow("l:",   "color#66ffff:span2:bold:c: 9:",  "color#66ffff:c:"+space(n[9]),  "color#66ffff:c:"+space(m[9]),  "color#66ffff:c:"+s9,  "color#66ffff:c:"+se9,  "bold:l:"); 
	newrow("l:",   "color#66ffff:span2:bold:c: 10:",  "color#66ffff:c:"+space(n[10]), "color#66ffff:c:"+space(m[10]),  "color#66ffff:c:"+s10,  "color#66ffff:c:"+se10,  "bold:l:"); 
	line(8);
	...
	newrow("span2:bold:c:");
	newrow("span2:bold:c:1:",   "l:"+m[1],  "c:"+l[1],  "c:"+u[1],     "bold:c:", 	"c:"+ll[1], "c:"+uu[1]); 
	newrow("span2:bold:c:2:",   "l:"+m[2],  "c:"+l[2],  "c:"+u[2],     "bold:c:", 	"c:"+ll[2], "c:"+uu[2]); 
	newrow("span2:bold:c:3:",   "l:"+m[3],  "c:"+l[3],  "c:"+u[3],     "bold:c:", 	"c:"+ll[3], "c:"+uu[3]); 
	newrow("span2:bold:c:4:",   "l:"+m[4],  "c:"+l[4],  "c:"+u[4],     "bold:c:", 	"c:"+ll[4], "c:"+uu[4]); 
	newrow("span2:bold:c:5:",   "l:"+m[5],  "c:"+l[5],  "c:"+u[5],     "bold:c:", 	"c:"+ll[5], "c:"+uu[5]); 
	newrow("span2:bold:c:6:",   "l:"+m[6],  "c:"+l[6],  "c:"+u[6],     "bold:c:", 	"c:"+ll[6], "c:"+uu[6]); 
	newrow("span2:bold:c:7:",   "l:"+m[7],  "c:"+l[7],  "c:"+u[7],     "bold:c:", 	"c:"+ll[7], "c:"+uu[7]); 
	newrow("span2:bold:c:8:",   "l:"+m[8],  "c:"+l[8],  "c:"+u[8],     "bold:c:", 	"c:"+ll[8], "c:"+uu[8]); 
	newrow("span2:bold:c:9:",   "l:"+m[9],  "c:"+l[9],  "c:"+u[9],     "bold:c:", 	"c:"+ll[9], "c:"+uu[9]); 
	newrow("span2:bold:c:10:",   "l:"+m[10],  "c:"+l[10],  "c:"+u[10],     "bold:c:", 	"c:"+ll[10], "c:"+uu[10]); 
	newrow("span8:bold:c:");
	line(8);
